...
PROGRAM_SUPERIORITY_OVERLAY=PROPOSAL_ONLY
...
A proposal branch, open PR, issue, source candidate, benchmark result, bot summary, stale status block or prior handoff cannot create product authority.
