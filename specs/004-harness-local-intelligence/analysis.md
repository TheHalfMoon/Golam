...
|---|---|---|---|
| A004-001 | MAJOR | Branch `AGENTS.md` still described Spec 003 implementation as active after Spec 003 had closed canonical. | FIXED in branch commit advancing instructions to Spec 004 planning and binding exact predecessor `main@6719e999...`. |
...
| A004-005 | NONE | ExecutionProfile frozen-field preservation | CONSISTENT |
...
Spec 004 adds immutable/versioned/content-derived identity without removing frozen semantics.
...
`SPEC_004_PLANNING_CROSS_ARTIFACT_CONVERGENCE=MATERIAL_FINDINGS_NONE_AFTER_REPAIR`

Remaining gates are operational rather than design findings: checklist freeze, Draft PR, exact-head CI, substantive independent external review, guarded merge and post-merge canonical-main CI.
