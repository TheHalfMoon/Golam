...
use crate::lifecycle::{
    Authenticate, ClientKeyId, EnrolledClientKey, LifecycleError, Ready, ServerLifecycle,
};
...
impl LocalClientEnrollment {
    ...
    pub fn authenticate_registered(
        ...
        let verifying_key = VerifyingKey::from_bytes(&record.public_key)
            .map_err(|_| EnrollmentError::InvalidPublicKey)?;
...
mod tests {
    ...
    #[test]
    fn enrolled_client_authenticates_then_revocation_blocks_new_session() {
