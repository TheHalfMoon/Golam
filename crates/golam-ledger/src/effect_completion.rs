...
use crate::security_audit::{self, EffectAttemptFinishedAuditInput, EffectTransitionAuditInput};
    ...
    pub fn complete(
        ...
        security_audit::append_effect_attempt_finished(
            ...
            EffectAttemptFinishedAuditInput {
                ...
                outcome: input.completion.attempt_outcome(),
                receipt: input.receipt,
            },
        )
        .map_err(|error| EffectCompletionError::SecurityAudit(error.to_string()))?;
